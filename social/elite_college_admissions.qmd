...
whether a college is public and/or flagship, note that flagship means public
...
Note that since private schools typically don't differentiate
in-state/out-of-state applications, they largely have any estimate related to
that as missing.
...
variables that we focus our analysis on.
