...
resp_vars = c("Id", "v18q", "escolari", "rez_esc", "male", "female", paste0("estadocivil", 1:7), paste0("parentesco", 1:12), paste0("instlevel1", 1:9), "mobilephone", "qmobilephone", "age")
...
p1 = ggplot(missings_grouped, aes(x = indicator, y = 100*percent_missing, fill = 100*percent_missing)) +
...
p2 = ggplot(missings_grouped_target, aes(x = indicator, y = Target, fill= 100*percent_missing)) + 
 geom_tile() +
 geom_text(aes(label = paste0(round(100*percent_missing, 1), "%")), 
...
Fabián Sánchez, Gary Soto, Julia Elliott, Luis Tejerina, and Phil Culliton. Costa Rican Household Poverty Level Prediction. <https://kaggle.com/competitions/costa-rican-household-poverty-prediction>, 2018. Kaggle.
