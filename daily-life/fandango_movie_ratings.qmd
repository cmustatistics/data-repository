...
| RottenTomatoes | The Rotten Tomatoes Tomatometer (critic review) score for the film (0.5-5 stars, aggregated to a 100 point scale) |
| RottenTomatoes_User | The Rotten Tomatoes user score for the film (0.5-5 stars, aggregated to a 100 point scale)|
...
## Questions
1. Perform an EDA of the Fandango fan ratings, compare how much and how often the average differs from the presented aggregate score `Fandango_Stars`.

2. Visualize the difference between Fandango ratings and other major platforms. Showcase the systemic differences however you like (hint: you can also use the user vote counts). Highlight what's surprising to you if there is.

3. Test the difference between IMDB ratings and Rotten Tomatoes user ratings, the difference between Metacritic critic ratings and Rotten Tomatoes critic ratings, and the difference between Fandango stars and ratings from any other platforms. Interpret the results.
