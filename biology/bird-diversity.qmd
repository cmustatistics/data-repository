...
date: July 10, 2019
description: Evolutionary theory suggests that species spread over a wider geographic range should have greater genetic diversity. Does this hold true in birds?
categories:
  - linear regression
  - hierarchical model
---
...
: [bird-diversity.csv](../data/bird-diversity.csv)
