...
2. Extend your model to control for the covariates used in the original study:
   ...
   anemia, deficiency anemia, and drug use. (However, smoking status was not
   provided in the public data, so you can't use it.) Interpret the results of
   this model, and compare it to the previous fit. What can you conclude about
