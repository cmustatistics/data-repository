...
date: June 8, 2023
description:
  Bloodletting---deliberately withdrawing large amounts of blood from patients---was a common medical practice for centuries, until evidence was finally collected on its efficacy. Use an early dataset to explore its use for pneumonia.
categories:
  - logistic regression
datayear: TODO
datafile: bloodletting.csv
---
