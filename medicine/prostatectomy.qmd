...
The primary outcome is whether the cancer recurred within 5 years. However, some
patients were not observed for a full 5 years, because the last records
available were less than 5 years after their surgery. These patients are
censored, meaning we have an indicator of whether they had recurrence in the
time period available, and a variable indicating how long they were monitored
post-surgery.
...
|----|-------------|
| RBC.Age.Group | Red blood cell (RBC) storage duration, grouped (1 = less than 13 days, 2 = 13-18 days, 3 = more than 18 days) |
...
| bGS | Biopsy Gleason score, discretized. Based on microscopic examination of cells in a biopsy. Low scores means the cells look normal, high scores mean they look abnormal. 1 = score 0-6, 2 = score 7, 3 = score 8-10. |
...
| sGS | Surgical Gleason score, discretized. Same type of measurement as bGS, but based on examination of the tumor removed in surgery, rather than on cells removed in a biopsy. 1 = not assigned, 2 = no disease or score 0-6, 3 = score 7, 4 = score 8-10. |
...
| Recurrence | Whether the prostate cancer recurred within 5 years (1 = yes, 0 = no) |
...
| TimeToRecurrence | Time to recurrence of prostate cancer, months; if censored (so the patient had no recurrence), the time from their surgery to the end of the study |
